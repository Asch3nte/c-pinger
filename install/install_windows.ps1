...
# Déclencheur : au démarrage de session + répétition toutes les heures
# (le programme gère lui-même la boucle, le trigger est juste pour le démarrage)
...
Write-Host ""
Write-Host "✅ ClaudePing installé et démarré !" -ForegroundColor Green
Write-Host ""
